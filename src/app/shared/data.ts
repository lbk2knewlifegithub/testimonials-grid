...
export const testimonials: Testimonial[] = [
  {
    ...
    option: {
      parent: 'bg-violet-900 text-white',
      avatar: 'border-violet-500',
      verified: 'text-gray-800',
  ...
  },
  {
    ...
    option: {
      ...
      avatar: '',
      title: '',
      content: 'text-gray-900 font-bold',
    },
  },
  {
  ...
  },
  {
    ...
    option: {
      parent: 'bg-blue-900 text-white',
      avatar: 'border-violet-900',
      title: '',
      content: '',
    },
  },
  {
    ...
    option: {
      verified: 'text-gray-900 text-opacity-100',
